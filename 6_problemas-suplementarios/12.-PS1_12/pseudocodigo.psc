Funcion calcularAreaTrianguloPorCoordenadas(X1,Y1,X2,Y2,X3,Y3)
	...
	superficie <- raiz(semiperimetro*(semiperimetro-distanciaP1P2)*(semiperimetro-distanciaP2P3)*(semiperimetro-distanciaP1P3))
	Borrar Pantalla
	...
	Escribir 'Semiperimetro: ',semiperimetro,' unidades'
	Escribir 'Superficie: ',superficie,' unidades'
FinFuncion
...
Algoritmo PS1_12
	...
	Leer cooY3
	calcularAreaTrianguloPorCoordenadas(cooX1,cooY1,cooX2,cooY2,cooX3,cooY3)
FinAlgoritmo
